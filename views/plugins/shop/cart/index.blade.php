                ...
                <div class="col-md-4">
                    ...
                    <form action="{{ route('shop.cart.coupons.add') }}" method="POST" >
                        ...
                        <div class="input-group mb-3 @error('code') has-validation @enderror">
                            <input type="text" class="input input-bordered w-full @error('code') input-error @enderror" placeholder="{{ trans('shop::messages.fields.code') }}" id="code" name="code" value="{{ old('code') }}">
